...
<html lang="en" >
   ...
   <!-- /Head -->
   <body data-ng-app="myWebApp" data-ng-controller="PlacementsController">
    <!-- NavBar -->
              ...
              <div class="container-fluid">
                ...
                <div id="BreadCrumb" data-ng-controller="ModuleController">
                  <ul>
                    ...
                    <a ng-click="setActiveAttendanceView('none')"><li style="display:inline">Placements</li></a>
                  </ul>
                </div>
                  ...
                  <div class = "row">
                    <div class="col-md-9 col-md-offset-1 pad-10" style="box-shadow:0px 2px 4px grey;background-color:white;">
                      <table class="table table-hover">
                        ...
                        <tbody>
                          <tr ng-repeat="detail in placements">
                            <td>{{$index+1}}</td>
                            <td>{{detail.title}}</td>
                        ...
                        <a style="float:right" ng-click="JSONToCSVConvertor(placements,'Placements Details','Placements')">DownloadReport</a>
                      </table>
                    </div>
                  </div>
                </div>
