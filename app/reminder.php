...
<html lang="en" >
   ...
   <!-- /Head -->
   <body data-ng-app="myWebApp" data-ng-controller="ReminderController">
    <!-- NavBar -->
        ...
        <div class="container-fluid">
          <div class="row" style="min-height:518px;display: -ms-flex; display: -webkit-flex; display: flex;">
            ...
            <div class="col-md-10" style="background-color:#F0F3F4;margin:0px;padding:0px;">
              <!-- Dashboard -->
              <div ng-show="activeReminderView=='none'">
                <?php include 'sub/administration/reminder/dash.php'; ?>
              </div>
              <!-- /Dashboard -->
              <div ng-hide="activeReminderView=='none'">
                <?php include 'sub/administration/reminder/cs.php'; ?>
              </div>
            </div>
            <!-- /Main Content -->
          </div>
