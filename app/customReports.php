...
<html lang="en" >
   ...
   <!-- /Head -->
   <body data-ng-app="myWebApp" data-ng-controller="CustomReportsController">
    <!-- NavBar -->
              ...
              <div class="container-fluid">
                ...
                <div id="BreadCrumb" data-ng-controller="ModuleController">
                  <ul>
                    ...
                    <a ng-click="setActiveReportsView('none')"><li style="display:inline">Custom Reports</li></a>
                  </ul>
                </div>
                <div class = "row">
                  <div class="col-md-10 col-md-offset-1 pad-10" style="box-shadow:0px 2px 4px grey;background-color:white;">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <tr ng-repeat="detail in customReportList">
                          <td>{{$index+1}}</td>
                          <td>{{detail.name}}</td>
                          <td><a>Show Report</a> | <a>Delete</a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
