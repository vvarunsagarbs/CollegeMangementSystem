...
<html lang="en" >
   ...
   <!-- /Head -->
   <body data-ng-app="myWebApp" data-ng-controller="FinanceController">
    <!-- NavBar -->
        ...
        <div class="container-fluid">
          <div class="row" style="min-height:518px;display: -ms-flex; display: -webkit-flex; display: flex;">
            ...
            <div class="col-md-10" style="background-color:#F0F3F4;margin:0px;padding:0px;">
              <!-- Dashboard -->
              <div ng-show="activeFinanceView=='none'">
                <?php include 'sub/administration/finance/dash.php'; ?>
              </div>
              <!-- /Dashboard -->
              <div ng-hide="activeFinanceView=='none'">
                <?php include 'sub/administration/finance/cs.php'; ?>
              </div>
            </div>
            <!-- /Main Content -->
          </div>
